                        ...
                        <Accordion defaultActiveKey="0" flush>
                            <Accordion.Item eventKey="0">
                                ...
                                <Accordion.Body>
                                    ...
                                    <a href="/use-cases/virtual-college-campus-tours" className="btn btn-primary">
                                        Learn More
                                    </a>
                                </Accordion.Body>
                            </Accordion.Item>
                            ...
                            <Accordion.Item eventKey="1">
                                ...
                                <Accordion.Body>
                                    ...
                                    <a href="/use-cases/journalism" className="btn btn-primary">
                                        Learn More
                                    </a>
                                </Accordion.Body>
                            </Accordion.Item>
                            ...
                            <Accordion.Item eventKey="2">
                                ...
                                <Accordion.Body>
                                    ...
                                    <a href="/use-cases/travel-and-tourism" className="btn btn-primary">
                                        Learn More
                                    </a>
                                </Accordion.Body>
                            </Accordion.Item>
                            ...
                            <Accordion.Item eventKey="3">
                                ...
                                <Accordion.Body>
                                    ...
                                    <a href="/use-cases/entertainment-sports-concerts" className="btn btn-primary">
                                        Learn More
                                    </a>
                                </Accordion.Body>
                            </Accordion.Item>
